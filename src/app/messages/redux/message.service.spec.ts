...
describe('MessageService', () => {
  ...
  it('should use user location when getting messages', inject([MessageService], (service: MessageService) => {
    ...
    const positionSpy = spyOn(geolocationService, 'getCurrentPosition').and.returnValue(Observable.of(positionToReturn));
  ...
  it('should use user location when saving a new message', inject([MessageService], (service: MessageService) => {
    const geolocationService = TestBed.get(GeolocationService);
    const messagesBackend = TestBed.get(MessageBackendService);
    const positionToReturn = {
      coords: {
